...
function DecisionListContent({ setDec }: Props) {
...
type Props = {
  setDec: (decision: DecisionResponse) => void;
};
export function DecisionList({ setDec }: Props) {
  return (
    <QueryClientProvider client={queryClient}>
      <DecisionListContent setDec={setDec} />
      <ReactQueryDevtools />
    </QueryClientProvider>
  );
}
